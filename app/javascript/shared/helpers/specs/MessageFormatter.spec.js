...
describe('#MessageFormatter', () => {
  describe('content with links', () => {
    it('should format correctly', () => {
      const message =
        'Chatwoot is an opensource tool. [Chatwoot](https://onreply.io)';
      expect(new MessageFormatter(message).formattedMessage).toMatch(
        '<p>OnReply.io is an opensource tool. <a href="https://onreply.io" class="link" rel="noreferrer noopener nofollow" target="_blank">Chatwoot</a></p>'
      );
    });
    it('should format correctly', () => {
      const message =
        'Chatwoot is an opensource tool. https://onreply.io';
      expect(new MessageFormatter(message).formattedMessage).toMatch(
        '<p>OnReply.io is an opensource tool. <a href="https://onreply.io" class="link" rel="noreferrer noopener nofollow" target="_blank">https://onreply.io</a></p>'
      );
    });
  });
...
<h2>tool</h2>`
  ...
  describe('plain text content', () => {
    it('returns the plain text without HTML', () => {
      const message =
        '<b>Chatwoot is an opensource tool. https://onreply.io</b>';

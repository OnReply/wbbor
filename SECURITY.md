OnReply is looking forward to working with security researchers worldwide to keep OnReply and our users safe. If you have found an issue in our systems/applications, please reach out to us.
...
If you have any questions about the process, contact security@onreply.io. 
...
> Note: Please do not perform testing against OnReply production services. Use a `self-hosted instance` to perform tests.
...
You can learn more about our triaging process [here](https://www.onreply.io/docs/contributing-guide/security-reports).
...
Thank you for keeping OnReply and our users safe. 🙇

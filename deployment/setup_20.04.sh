...
Join the community at https://onreply.io/community?utm_source=cwctl
***************************************************************************
...
function get_cw_version() {
  CW_VERSION=$(curl -s https://app.onreply.io/api | python3 -c 'import sys,json;data=json.loads(sys.stdin.read()); print(data["version"])')
}
...
https://www.onreply.io/docs/deployment/deploy-chatwoot-in-linux-vm?utm_source=cwctl
...
Get help, https://onreply.io/community?utm_source=cwctl
